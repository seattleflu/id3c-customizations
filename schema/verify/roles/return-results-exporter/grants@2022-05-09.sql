...
select 1/(pg_catalog.has_table_privilege('return-results-exporter', 'operations.deliverables_log', 'insert'))::int;
...
select 1/(not pg_catalog.has_table_privilege('return-results-exporter', 'operations.deliverables_log', 'select,update,delete'))::int;
