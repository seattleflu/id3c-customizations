...
insert into warehouse.site(identifier, details)
    values
        ('Apple',                                   '{"category": "community",  "type": "apple-study", 
            "sample_origin": "apple"}'),
        ('AvalonFederalWayCareCenter',              '{"category": "community",  "type": "shelter", 
            "swab_site": "avalon"}'),
        ('BirchTreeAcademy',                        '{"category": "community",  "type": "childcare"}'),
        ('BoeingField',                             '{"category": "community",  "type": "shelter", 
            "swab_site": "boeing"}'),
        ('BurienNursingAndRehab',                   '{"category": "community",  "type": "nursingHome", 
        ...
        ('ClinicalWorkplace',                       '{"category": "clinic",     "type": "clincalWorkplace",
            "sample_origin": "clinical_workplace"}'),
        ('ColumbiaLutheranHome',                    '{"category": "community",  "type": "nursingHome", 
        ...
        ('CristaRehabAndSkilledNursingCare',        '{"category": "community",  "type": "nursingHome",
            "swab_site": "crista"}'),
        ...
        ('FryeApartments',                          '{"category": "community",  "type": "nursingHome",
            "swab_site": "frye"}'),
        ('KlineGallandHome',                        '{"category": "community",  "type": "nursingHome",
        ...
        ('IssaquahNursingAndRehab',                 '{"category": "community",  "type": "nursingHome",
            "swab_site": "issaquah_nursing"}'),
        ('JudsonPark',                              '{"category": "community",  "type": "nursingHome",
        ...
        ('Lazarus',                                 '{"category": "community",  "type": "shelter",
            "swab_site": "lazarus"}'),
        ('LifeCareCenter',                          '{"category": "community",  "type": "nursingHome",
            "swab_site": "life_care"}'),
        ...
        ('MissionHealthcare',                       '{"category": "community",  "type": "nursingHome",
            "swab_site": "mission"}'),
        ('MothersPlace',                            '{"category": "community",  "type": "childcare"}'),
        ('Oaks',                                    '{"category": "community",  "type": "nursingHome",
            "swab_site": "oaks"}'),
        ('ParkWestCareCenter',                      '{"category": "community",  "type": "nursingHome",
            "swab_site": "park_west_care"}'),
        ('PICAWA',                                  '{"category": "community",  "type": "publicSpace"}'),
        ('PioneerSquare',                           '{"category": "clinic",     "type": "clinic"}'),
        ('ProvidenceMountStVincent',                '{"category": "community",  "type": "nursingHome",
        ...
        ('QueenAnneHealthcare',                     '{"category": "community",  "type": "nursingHome",
        ...
        ('SeattleMedicalPostAcuteCare',             '{"category": "community",  "type": "nursingHome",
            "swab_site": "seattle_medical"}'),
        ('self-test',                               '{"category": "community",  "type": "self-test",
            "swab_site": "home_test"}'),
        ('ShorelineHealthAndRehab',                 '{"category": "community",  "type": "nursingHome",
        ...
        ('Spruce',                                  '{"category": "community",  "type": "shelter",
            "swab_site": "spruce"}'),
        ('StaffordHealthcare',                      '{"category": "community",  "type": "nursingHome",
            "swab_site": "stafford"}'),
