...
insert into warehouse.site(identifier, details)
    values
        ...
        ('UWReopeningDropbox',                      '{"category": "community",  "type": "uw-reopening",
            "swab_site": "uw_box"}'),
        ('UWReopeningDropboxTacoma',                '{"category": "community",  "type": "uw-reopening",
            "swab_site": "HCT_dropbox_tacoma"}'),
        ('UWReopeningDropboxBothell',               '{"category": "community",  "type": "uw-reopening",
            "swab_site": "HCT_dropbox_bothell"}'),
        ('UWReopeningDropboxSLU',                   '{"category": "community",  "type": "uw-reopening",
            "swab_site": "HCT_dropbox_SLU"}'),
        ('UWReopeningDropboxHUB',                   '{"category": "community",  "type": "uw-reopening",
            "swab_site": "HCT_dropbox_HUB"}'),
        ('UWReopeningDropboxHSB',                   '{"category": "community",  "type": "uw-reopening",
            "swab_site": "HCT_dropbox_HSB"}'),
        ('UWReopeningDropboxLander',                '{"category": "community",  "type": "uw-reopening",
            "swab_site": "HCT_dropbox_lander"}'),
